...
import AdminStatCard from '@/components/Custom/AdminStatCard';
...
const AdminDashboard = () => {
  ...
  return (
    ...
    <div className="w-full  md:p-10 p-2 flex  flex-col xl:flex-row">
        <div className="  sm:flex flex-col items-center md:min-w-60 w-[95%] min-h-full overflow-hidden text-gray-400 bg-[#023047] rounded-xl">
          ...
          <div className="w-full px-2">
            <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
              ...
              >
                ...
                {/* {lang ? "See all News" : " सबै समाचार हेर्नुहोस्"} */}
                </span>
              </Link>
              <Link
                className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300"
                href="/admin/ArchievedNews"
              >
                <svg
                  className="w-6 h-6 stroke-current"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                {/* {lang ? "Archived News" : " संग्रहित समाचार"} */}
                </span>
              </Link>
            </div>
            <div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
              ...
              >
                ...
                <span className="ml-2 text-sm font-medium">
                {/* {lang ? "Deleted News " : "  हटाइएको समाचार"} */}
                </span>
              </Link>
              <a
        ...
        <div className=" w-full md:mx-10 md:rounded-xl rounded-none ">
          <div className=" text-2xl p-2 text-[#023047] font-bold">
            Dashboard
          </div>
          <div className=" flex justify-between p-2  items-center flex-col sm:flex-row">
